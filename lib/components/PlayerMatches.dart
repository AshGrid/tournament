    ...
    try {
      ...
      if (mounted) {
        setState(() {
          ...
          isLoading = false; // Data has been fetched, set loading to false
        });
      }
    } catch (error) {
      if (mounted) {
  ...
  Widget build(BuildContext context) {
    return Scrollbar(
      child: Container(
        ...
        child: isLoading
            ? Center(child: CircularProgressIndicator(color: Colors.white,)) // Show loading indicator while fetching matches
            : ListView(
