      ...
      child: Scrollbar(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            final event = match.matchEvents[index];
            ...
            return Row(
              ...
              children: [
                ...
                if (event.team == match.homeTeam) // Check if event team is the first team
                  Expanded(
                    child: Container(
                ...
                if (event.team == match.awayTeam) // Check if event team is the second team
                  Expanded(
                    child: Container(
                      padding: EdgeInsets.symmetric(vertical: 10, horizontal: 5),
