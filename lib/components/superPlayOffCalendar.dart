  ...
  final List<Map<String, dynamic>> roundsWithMatches = [
    {
      ...
      'matches': [
        ...
        Match(homeTeam: 'Team C', awayTeam: 'ennakl', homeScore: 2, awayScore: 1, matchStatus: 'live', matchTime: '20:00', homeTeamLogo: 'assets/images/team_c.jpg', awayTeamLogo: 'assets/images/team_d.jpg'),
      ]
    },
    {
      'round': 'Semifinal',
